 ...
 */
public abstract class LoadingDetailTask extends NetworkTask {

    private KSimpleApplication context;

    public LoadingDetailTask(String tag, KSimpleApplication context, Class resultClass, HashMap requestParams, String serverURL, int requestType) {
